...
const SITE_CONTENT = {
  ...
  hero: {
    ...
    slogan: "Moda que realça você",
    subtitle: "Moda para todos os momentos.",
    buttonText: "VER NOVIDADES",
    buttonTarget: "#novidades",
    imageDesktop: "",
    imageMobile: "",
    ...
    enabled: true,
    image: "",
    imageAlt: "Banner promocional Vitrine Moda",
  },
  sections: {
...
const PRODUCTS = [
  ...
  },
  {
    ...
    imagens: [
      "fotos/blusa-canelada-rosa.jpg",
      "fotos/vestido-midi-floral.jpg",
    ],
    status: "Disponível",
    destaque: true,
    promocao: false,
  ...
  },
  {
    ...
    imagens: [
      "fotos/look-casual-urbano.jpg",
      "fotos/look-noite-evento.jpg",
      "fotos/bermuda-sarja-bege.jpg",
    ],
    status: "Disponível",
    destaque: true,
    promocao: false,
  ...
  },
  {
    ...
    imagens: [
      "fotos/vestido-envelope-plus.jpg",
    ],
    status: "Esgotado",
    destaque: false,
    promocao: false,
